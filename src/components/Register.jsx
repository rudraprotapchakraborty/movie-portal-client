...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gradient-to-r from-green-100 to-green-300 dark:from-gray-800 dark:to-gray-900 transition-colors duration-500 p-8">
      <motion.div
